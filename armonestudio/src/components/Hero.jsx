      ...
      <div className="relative container min-h-[72vh] md:min-h-[80vh] flex items-center">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href="#prenota" className="btn">Prenota ora</a>
            <a href="#classi" className="inline-flex items-center rounded-full px-6 py-3 border border-brand-200 text-brand-50/95 bg-brand-400/30 backdrop-blur hover:bg-brand-400/40 transition">
              Le nostre classi
            </a>
          </div>
        </div>
